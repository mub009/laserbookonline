...
public class AppointmentDetails extends AppCompatActivity{
    ...
    TextView txtbox_BalanceAmount;
    TextView txtbox_PaidAmount;
    ...
    LinearLayout LnrLyt_BalanceAmount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadlocal();
        LnrLyt_BalanceAmount=(LinearLayout) findViewById(R.id.LnrLyt_BalanceAmount);
        ...
        txtbox_BalanceAmount=(TextView) findViewById(R.id.txtbox_BalanceAmount);
        txtbox_PaidAmount=(TextView) findViewById(R.id.txtbox_PaidAmount);
//
//        TextView txtbox_BalanceAmount;
//        TextView txtbox_PaidAmount;
        ...
        paymentType.setText(paymentTypevalue);

        if (lng.equals("ar")) {
            if (Appointment_data.get("paid").equals(0))
                paid_app = "قيد الانتظار";
            else if(Appointment_data.get("paid").equals(1))
                paid_app = "نجاحا";
             else if(Appointment_data.get("paid").equals(2))
                paid_app = "Refund Pending";
            else if(Appointment_data.get("paid").equals(3))
                paid_app = "استوفى حقه";
...
//        completed
        ...
        if(Appointment_data.get("is_partiallyRecord").equals("1"))
        {

            if (statusvalue.equals("completed")) {
//                            Integer cpartiallyPaidAmount=Integer.valueOf(Appointment_data.get("partiallyPaidAmount"));
//                            Integer cbalanceAmount=Integer.valueOf(Appointment_data.get("balanceAmount"));
//                            Integer sum=cpartiallyPaidAmount+cbalanceAmount;
//
//
                            txtbox_PaidAmount.setText(Appointment_data.get("completed"));
                            LnrLyt_BalanceAmount.setVisibility(View.GONE);
                            txtbox_PaidAmount.setText(Appointment_data.get("finalAmount"));

            } else {
                txtbox_BalanceAmount.setText(Appointment_data.get("balanceAmount"));
                txtbox_PaidAmount.setText(Appointment_data.get("partiallyPaidAmount"));
            }
        }
        else {
            LnrLyt_BalanceAmount.setVisibility(View.GONE);
