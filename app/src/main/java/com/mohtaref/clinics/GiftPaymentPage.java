...
public class GiftPaymentPage extends AppCompatActivity{
    ...
    Calendar calendar;
    HashMap<String, String> provider_hash,serviceDetails,clinic_details;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gift_checkout);
        ...
        Promomsg=findViewById(R.id.PromomsgArea);
        ...
        PromocodeDetails = new HashMap<String, String>();
        ...
        depostDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                DatePickerDialog date_dialog = new DatePickerDialog(GiftPaymentPage.this, finalDate, myCalendar
        ...
        PromoCodeChecking.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                //alert_message("credit,cash","credit,cash","credit,cash");
            }
        });

        btn_PromoCoderemove.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//
        ...
        Log.e("offer mubashir",offer.toString());
        ...
        serviceDetails =new HashMap<String, String>();
        clinic_details=new HashMap<String, String>();
    ...
    public void creditcall() {
        ...
        if (creditPaymentData.get("redirect_url") != null) {
            WebView wv = new WebView(GiftPaymentPage.this) {
                @Override
            ...
            AlertDialog.Builder alert = new AlertDialog.Builder(GiftPaymentPage.this);
    ...
    public void alert_message(String title, String body, String status) {
        AlertDialog alertDialog = new AlertDialog.Builder(GiftPaymentPage.this).create();
        alertDialog.setTitle(title);
        alertDialog.setMessage(body);
                ...
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        if (paid.trim().equals("paid")) {
                            Intent i = new Intent(GiftPaymentPage.this, GiftShare.class);
                            i.putExtra("transaction_id",creditPaymentData.get("transaction_id"));
                            startActivity(i);
                            finishAffinity();
                        }
                        if (paid.trim().equals("pending_payment")) {
                            Intent i = new Intent(GiftPaymentPage.this, HomePage.class);
                            startActivity(i);
                            finishAffinity();
                            System.exit(0);
...
//            final FormActivity formobject=new FormActivity();
            ...
            String urlget = base_url + "partiallycheckoutDetails";
            String jsonStr = null;

            Log.e("base_url :", "base_url: " + urlget);
            ...
            try {
                ...
                {
                    jsonParam.put("serviceStatus","service");
                }
            ...
            if (jsonStr != null) {
                try {
                    ...
                    // tmp hash map for single offer
                    HashMap<String, String> serviceDetails_ob = new HashMap<>();
                    serviceDetails_ob.put("ClinicPercentage", service.getString("ClinicPercentage"));
                    serviceDetails_ob.put("balanceAmount", service.getString("balanceAmount"));
                    serviceDetails_ob.put("postCost", service.getString("postCost"));
                    ...
                    serviceDetails_ob.put("giftValidityInDays", service.getString("giftValidityInDays"));
        ...
        protected void onPostExecute(Void result) {
            try {
                ...
                partiallypaidAmount = (TextView) findViewById(R.id.partiallypaidAmount);
                ...
                txtpartiallypaidAmount = (TextView) findViewById(R.id.textView83);
                    ...
                    CreditPaymentApi = "createGiftUrlAndOrder";
...
//            CreditPaymentApi
                ...
                if (lng.equals("ar")) {
                    ...
                    date_checkout.setText(serviceDetails.get("giftValidityInDays")+" expire");
                ...
                if (PaymentType.trim().equals("credit")) {
                    ...
                    // alert_message("credit","credit","credit");
                    ...
                    //alert_message("transfer","transfer","transfer");
...
//            final FormActivity formobject=new FormActivity();
            ...
            // Making a request to url and getting response
            String urlget = base_url + "partiallycreateReservation";
            String jsonStr = null;
            ...
            if (jsonStr != null) {
                ...
                //alert_message("success 1","success 1","success 1"+jsonStr);

                //Log.e("Beforemubashir", "1" + c.toString());
...
//                    }
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        alert_message("Couldn't get json from server 3","Couldn't get json from server 3","Couldn't get json from server 3");
...
//                                Toast.LENGTH_LONG).show();
        ...
        protected void onPostExecute(String result) {
            ...
            Intent intent=new Intent(GiftPaymentPage.this,SuccessPage.class);
            startActivity(intent);
            finishAffinity();
...
//            final FormActivity formobject=new FormActivity();
            ...
            // Making a request to url and getting response
            String urlget = base_url + CreditPaymentApi;
            String jsonStr = null;
...
//            if(Integer.parseInt(result)>0){
    ...
    public class PromoCode extends AsyncTask<Void, Void, Void> {
        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            // getLastLocation();
...
//            Log.e("is offers :", "Response from url countries: " + jsonStr);
            if (jsonStr != null) {
                try {
                    //  JSONArray c = new JSONArray(jsonStr);
                    //JSONObject CouponDetails = c.getJSONObject(0);
//
//                    System.out.print(CouponDetails.getString("status"));
                    ...
                    PromocodeDetails.put("status",c.getString("status"));
                    PromocodeDetails.put("message_en",c.getString("message_en"));
                    PromocodeDetails.put("body_en",c.getString("body_en"));

                    PromocodeDetails.put("message_ar",c.getString("message_ar"));
                    PromocodeDetails.put("body_ar",c.getString("body_ar"));

                    PromocodeDetails.put("discountAmount",c.getString("discountAmount"));
...
//                                Toast.LENGTH_LONG).show();
        ...
        protected void onPostExecute(Void result) {
            ...
            TextView txtPromocodeHeadMsg,txtPromocodeBodyMsg;
            txtPromocodeHeadMsg=findViewById(R.id.txtPromocodeHeadMsg);
            txtPromocodeBodyMsg=findViewById(R.id.txtPromocodeBodyMsg);



//            PromocodeDetails.get("status");
            ...
            if(lng.equals("ar")){
                ...
                if(PromocodeDetails.get("status").equals("fail"))
                {

                    //alert_message("Coupon Message",""+PromocodeDetails.get("message"),"ss");
